...
`wiki/` is deliberately in-repo rather than a hosted wiki: docs version with the code you pulled. Fork the repo, or stay on an older release, and the docs describe *that* version.
