...
# Chat system prompt - loaded from file for easy switching
# Set CHAT_PROMPT_FILE env var to use a different prompt (e.g., "chat-system-v1.md")
_prompt_file = os.environ.get("CHAT_PROMPT_FILE", "chat-system.md")
_prompt_path = BASE_DIR / "prompts" / _prompt_file
try:
    CHAT_SYSTEM_PROMPT = _prompt_path.read_text()
except FileNotFoundError:
    raise ValueError(f"Chat prompt file not found: {_prompt_path}")
